...
public class StepOutputSchemaHelper {
    ...
    public StepOutputSchema knowledgeRetrievalSchema() {
        return StepOutputSchema.builder()
                ...
                .fields(List.of(OutputField.of("output", "Retrieved Answer", "string")))
                .build();
    }
    ...
    public StepDefinition triggerIntentDefinition() {
        return genericDefinition("TRIGGER_INTENT", "interaction", "Trigger Intent", "hgi-flash", "step-trigger");
    }
